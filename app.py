...
# Set up custom session with headers
session = requests.Session()
session.headers['User-agent'] = 'Mozilla/5.0'

# Apply the custom session to yfinance
yf.set_session(session)

# App layout (keep your existing layout)
app.layout = html.Div([
...
def update_stock_data(ticker):
    ...
    try:
        ...
        # Use date range instead of period to be more reliable
